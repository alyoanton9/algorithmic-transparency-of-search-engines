...
def log_date_to_full_date(log_date: str) -> FullDate:
  '''
...
def iso_date_to_full_date(iso_date: str) -> FullDate:
  '''
...
def full_date_to_log_date(full_date) -> str:
  ...
  Example:
    FullDate(2021, 3, 29, 13, 47, 5) -> 29/03/2021 13:47:05.
  '''
  y = full_date.year
  m = full_date.month
  d = full_date.day
